...
set firewall zone network interface 'eth5'
...
set firewall zone servers interface 'eth5.2'
...
set firewall zone iot interface 'eth5.3'
...
set firewall zone trusted interface 'eth5.5'
