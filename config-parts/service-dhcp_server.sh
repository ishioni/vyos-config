...
set service dhcp-server shared-network-name SERVERS subnet 10.1.2.0/24 domain-name 'servers.internal'
set service dhcp-server shared-network-name SERVERS subnet 10.1.2.0/24 domain-search 'servers.internal'
