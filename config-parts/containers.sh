...
set container name unifi environment PGID value '1002'
set container name unifi environment PUID value '102'
...
# meshcentral
set container name meshcentral image 'ghcr.io/ylianst/meshcentral:1.1.20'
