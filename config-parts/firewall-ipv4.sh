...
set firewall ipv4 name wan-servers rule 110 destination address '192.168.3.2'
...
set firewall ipv4 name wan-servers rule 120 destination address '192.168.3.2'
...
set firewall ipv4 name wan-servers rule 130 destination address '192.168.3.4'
...
set firewall ipv4 name wan-servers rule 140 destination address '192.168.3.10'
