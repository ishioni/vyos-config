...
set protocols bgp neighbor 10.1.2.2 remote-as '65501'
...
set protocols bgp neighbor 10.1.2.30 remote-as '65502'
...
set protocols bgp neighbor 10.1.2.31 remote-as '65502'
...
set protocols bgp neighbor 10.1.2.32 remote-as '65502'
...
set protocols bgp neighbor 10.1.2.40 remote-as '65502'
...
set protocols bgp neighbor 10.1.2.41 remote-as '65502'
...
set protocols bgp neighbor 10.1.2.42 remote-as '65502'
