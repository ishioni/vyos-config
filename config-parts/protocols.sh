...
set protocols bgp neighbor 10.1.4.10 remote-as '65001'
...
set protocols bgp neighbor 10.1.4.11 remote-as '65001'
...
set protocols bgp neighbor 10.1.4.12 remote-as '65001'
...
set protocols bgp neighbor 10.1.4.20 remote-as '65001'
...
set protocols bgp neighbor 10.1.4.21 remote-as '65001'
...
set protocols bgp neighbor 10.1.4.22 remote-as '65001'
