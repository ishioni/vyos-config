...
# set nat destination rule 200 inbound-interface name 'eth5'
...
# set nat destination rule 220 inbound-interface name 'eth5.2'
...
# set nat destination rule 230 inbound-interface name 'eth5.3'
...
# set nat destination rule 250 inbound-interface name 'eth5.5'
