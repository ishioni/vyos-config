...
set nat destination rule 220 inbound-interface name 'eth4.2'
...
set nat destination rule 230 inbound-interface name 'eth4.3'
...
set nat destination rule 240 inbound-interface name 'eth4.4'
...
set nat destination rule 250 inbound-interface name 'eth4.5'
