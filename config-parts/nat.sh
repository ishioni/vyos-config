...
set nat destination rule 201 description 'Force NTP for LAN'
set nat destination rule 201 destination address '!10.1.2.1'
set nat destination rule 201 destination port '123'
set nat destination rule 201 inbound-interface 'eth4.2'
set nat destination rule 201 protocol 'udp'
set nat destination rule 201 translation address '10.1.2.1'
set nat destination rule 201 translation port '123'

set nat destination rule 202 description 'Force NTP for IOT'
set nat destination rule 202 destination address '!10.1.3.1'
set nat destination rule 202 destination port '123'
set nat destination rule 202 inbound-interface 'eth4.3'
set nat destination rule 202 protocol 'udp'
set nat destination rule 202 translation address '10.1.3.1'
set nat destination rule 202 translation port '123'

set nat destination rule 203 description 'Force NTP for KUBERNETES'
set nat destination rule 203 destination address '!10.1.4.1'
set nat destination rule 203 destination port '123'
set nat destination rule 203 inbound-interface 'eth4.4'
set nat destination rule 203 protocol 'udp'
set nat destination rule 203 translation address '10.1.4.1'
