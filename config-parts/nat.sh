...
set nat destination rule 201 inbound-interface 'eth4'
...
set nat destination rule 202 inbound-interface 'eth4.2'
...
set nat destination rule 203 inbound-interface 'eth4.3'
...
set nat destination rule 204 inbound-interface 'eth4.4'
